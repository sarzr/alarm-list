...
import { IPermissonModal } from "../types/main.d";

export const PermissionModal: React.FC<IPermissonModal> = ({
  deleteAlarm,
  setShowModalDelete,
}) => {
      ...
      <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          <div
            ...
            className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 p-2 sm:max-w-lg"
          >
